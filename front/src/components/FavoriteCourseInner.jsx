              ...
              <div className='course-item__content'>
                <div className=''>
                  <h4 className='mb-28'>
                    ...
                    Mastering English: From Beginner to Fluent
                    </Link>
                  </h4>
            ...
            <div className='course-item bg-white rounded-16 p-12 h-100 box-shadow-md'>
              ...
              <div className='course-item__content'>
                <div className=''>
                  <h4 className='mb-28'>
                    <Link href='/course-details' className='link text-line-2'>
                    Français Facile : Apprenez à Parler avec Confiance                    </Link>
                  </h4>
                  <div className='flex-between gap-8 flex-wrap mb-16'>
                    <div className='flex-align gap-8'>
                      <span className='text-neutral-700 text-2xl d-flex'>
            ...
            <div className='course-item bg-white rounded-16 p-12 h-100 box-shadow-md'>
              ...
              <div className='course-item__content'>
                <div className=''>
                  <h4 className='mb-28'>
                    <Link href='/course-details' className='link text-line-2'>
                    Español Express: Parlez Espagnol en 30 Jours                    </Link>
                  </h4>
                  <div className='flex-between gap-8 flex-wrap mb-16'>
                    <div className='flex-align gap-8'>
                      <span className='text-neutral-700 text-2xl d-flex'>
            ...
            <div className='course-item bg-white rounded-16 p-12 h-100 box-shadow-md'>
              ...
              <div className='course-item__content'>
                <div className=''>
                  <h4 className='mb-28'>
                    <Link href='/course-details' className='link text-line-2'>
                    Japanese Made Simple: Speak Like a Native                    </Link>
                  </h4>
                  <div className='flex-between gap-8 flex-wrap mb-16'>
                    <div className='flex-align gap-8'>
                      <span className='text-neutral-700 text-2xl d-flex'>
            ...
            <div className='course-item bg-white rounded-16 p-12 h-100 box-shadow-md'>
              ...
              <div className='course-item__content'>
                <div className=''>
                  <h4 className='mb-28'>
                    <Link href='/course-details' className='link text-line-2'>
                    Russian Bootcamp: Learn Cyrillic & Speak Fast                    </Link>
                  </h4>
                  <div className='flex-between gap-8 flex-wrap mb-16'>
                    <div className='flex-align gap-8'>
                      <span className='text-neutral-700 text-2xl d-flex'>
